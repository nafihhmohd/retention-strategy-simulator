...
if page == "🏠  Project Overview":
    st.markdown("""<div style='background:#0d1f3c;border:1px solid #1e3a5f;border-radius:8px;
        padding:9px 16px;margin-bottom:16px;font-size:12px;color:#4a7fa5'>
        ☰ &nbsp;Use the <b style='color:#93c5fd'>› arrow on the left edge</b> to open the sidebar and navigate between pages
    </div>""", unsafe_allow_html=True)
